...
export const getStaticProps: GetStaticProps = async () => {
  ...
  const { data: officers } = await supabase.storage
    .from('officer-images')
    .list(undefined, { offset: 1 })
  // Offset gets rid of the .emptyFolderPlaceholder bullshit

  return { props: { events: data, officers } }
}
      ...
      <main>
        <div className={styles.content}>
          ...
          <OfficerImage
            ...
            first_name='Shredquarters_logo.jpg'
            // last_name=''
          />
